 ...
 export function CustomersHeader({ searchQuery, onSearchChange }: Props) {
       ...
       <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
         ...
         <DialogContent className="sm:max-w-[480px]">
           ...
           <div className="space-y-4">
             ...
             <Input value={newTags} onChange={(e) => setNewTags(e.target.value)} placeholder="وسوم مفصولة بفواصل مثل: VIP, جديد" />
