  ...
  return (
    ...
    <ScreenWrapper edges={["top"]}>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        {/* Team and Permissions (Admin only) */}
        {isAdmin && (
          <View style={styles.section}>
            <Text style={[styles.sectionTitle, rtlText, styles.cairoFont]}>
              {t("team_permissions")}
            ...
            <View style={styles.card}>
              {user?.role && (
                <View style={[styles.settingRow, rtlRow]}>
                  <View style={[styles.settingLabel, rtlRow]}>
                    ...
                    <Text style={[styles.settingText, styles.cairoFont]}>
                      {locale === "ar" ? "دورك الحالي" : "Your role"}
                    </Text>
                  </View>
                  <Text style={[styles.valueText, styles.cairoFont]}>
                    {user.role === "admin"
                      ? locale === "ar"
                        ? "مدير"
                        : "Admin"
              ...
              <Link href="/users" asChild>
                <TouchableOpacity style={[styles.settingRow, rtlRow]}>
                  <View style={[styles.settingLabel, rtlRow]}>
